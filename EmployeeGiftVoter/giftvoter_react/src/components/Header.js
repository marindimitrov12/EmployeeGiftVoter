    ...
    return (<>
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container px-4 px-lg-5">
                <a className="navbar-brand" href="#!">GiftVoter</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Menu</a>
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><Link className="dropdown-item" to="/myEvents">MyEvents</Link></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <header className="bg-dark py-5">
            <div className="container px-4 px-lg-5 my-5">
                <div className="text-center text-white">
                   ...
                   {user.role==='Employee'&& <h1 className="display-4 fw-bolder">GiftVoter</h1>}
                    <p className="lead fw-normal text-white-50 mb-0">Choose the best pressent for your colleagues</p>
                </div>
            </div>
        </header>
    </>)
